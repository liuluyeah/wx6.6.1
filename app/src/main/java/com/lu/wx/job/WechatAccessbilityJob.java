...
import com.lu.wx.BuildConfig;
import com.lu.wx.Config;
import com.lu.wx.IStatusBarNotification;
import com.lu.wx.QHBApplication;
import com.lu.wx.QiangHongBaoService;
import com.lu.wx.util.AccessibilityHelper;
import com.lu.wx.util.NotifyHelper;
...
public class WechatAccessbilityJob extends BaseAccessbilityJob {
    ...
    private boolean isMemberChatUi(AccessibilityNodeInfo nodeInfo) {
        ...
        String id = "com.tencent.mm:id/bx4";
        int wv = getWechatVersion();
        if(wv <= 680) {
            id = "com.tencent.mm:id/bx4";
        } else if(wv <= 700) {
            id = "com.tencent.mm:id/bx4";
        }
        String title = null;
    ...
    private void handleLuckyMoneyReceive() {
        ...
        if(event == Config.WX_AFTER_OPEN_HONGBAO) { //拆红包
            if (wechatVersion < USE_ID_MIN_VERSION) {
                ...
                String buttonId = "com.tencent.mm:id/bx4";
